...
export type { ChipProps, ChipVariant } from "@/components/ui/chip";
...
export type { DropdownItem, DropdownProps } from "@/components/ui/dropdown";
...
export type { TextProps, TextVariant } from "@/components/ui/text";
